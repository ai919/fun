...
<h1>测试列表</h1>
<p class="hint">
    像 WordPress 一样集中管理所有测试：查看、编辑题目和结果、查看统计、克隆、删除等。
</p>
            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($t['cover_image'])): ?>
                        <a href="<?= htmlspecialchars($t['cover_image']) ?>" target="_blank">
                            <img src="<?= htmlspecialchars($t['cover_image']) ?>" alt="封面" style="width:80px;height:50px;object-fit:cover;border-radius:6px;border:1px solid #e5e7eb;">
                        </a>
                    <?php else: ?>
                ...
                <td class="actions">
                    ...
                    <a class="btn-mini"
                       href="/admin/results.php?test_id=<?= (int)$t['id'] ?>">
                        结果区间
                    </a>
                    <a class="btn-mini"
